    ...
    JOBS: [
      ...
      },
      {
        ...
        SKILLBULLET: [
          {
            BULLET:
              "EW software developer w/ Python; utilized Agile dev processes and SVN version control",
            SKILLS: [
              "Software Engineering",
              "Agile",
              "Python",
          ...
          {
            BULLET:
              "Implemented micro-service architecture utilizing RabbitMQ message broker communication protocols",
            SKILLS: [
              "Software Engineering",
              "Agile",
              "Python",
          ...
          {
            BULLET:
              "Developed UI upgrades for application testing; Defined JSON data structures and HTML/JS UI elements",
            SKILLS: [
              "Software Engineering",
              "Agile",
              "Python",
          ...
          {
            BULLET:
              "Authored requirements, meeting documentation, test cases, and other non-source code artifacts",
            SKILLS: [
              "Software Engineering",
              "Agile",
              "Python",
      ...
      {
        TITLE:
          "Course Director, Avionics Cyber Vulnerability, Mitigation, and Protection",
        SKILLBULLET: [
          {
            BULLET:
              "Develops/instructs course for avionics cyber vulnerability assessment processes for system program managers",
            SKILLS: [
              "Software Engineering",
              "Cyber Security",
              "Security+",
          ...
          {
            BULLET:
              "Developed/taught courses on software testing, development life-cycles, engineering & management topics",
            SKILLS: [
              "Software Engineering",
              "Agile",
              "Teaching",
          ...
          {
            BULLET:
              "Developed 5+hrs video lesson content on Software Testing— TDD, Unit, Black-box, White-box, Integration, Planning",
            SKILLS: [
              "Software Engineering",
              "Agile",
              "Teaching",
          ...
          {
            BULLET:
              "Coordinates with senior USAF officials to ensure cyber security and software education requirements are met",
            SKILLS: [
              "Software Engineering",
              "Consulting",
              "Critical Thinking",
          ...
          {
            BULLET:
              "Manages collaboration through milSuite.mil; develops custom web interactions and products",
            SKILLS: [
              "HTML5",
              "CSS",
              "JavaScript",
          ...
          {
            BULLET:
              "Developed multiple HTML5/JavaScript utilities to support and display self-created educational video content",
            SKILLS: ["Critical Thinking", "JavaScript", "HTML5", "Programming"],
          },
          {
            BULLET:
              "Managed SharePoint 2007/2013 intranet for 10K+ users; design custom sites, web parts, managed permissions",
            SKILLS: [
              "HTML5",
              "JavaScript",
              "MS Office",
      ...
      {
        TITLE:
          "Branch Chief, Network Infrastructure / Plans & Programs Division Chief",
        SKILLBULLET: [
          {
            BULLET:
              "Led 9 civ/mil personnel in Plans & Programming, Budget, and Information Assurance",
            SKILLS: [
              "Leadership",
              "Management",
              "Strategic Planning",
          ...
          {
            BULLET:
              "Directed/managed Air Force Institute of Technology Network Certification and Accreditation process",
            SKILLS: [
              "Leadership",
              "Management",
              "Strategic Planning",
          ...
          {
            BULLET:
              "Managed CISCO network infrastructure, VoIP, Video Conferencing System",
            SKILLS: [
              "Leadership",
              "Management",
              "Strategic Planning",
      ...
      },
      {
        ...
        SKILLBULLET: [
          {
            BULLET:
              "Led 90 mil/civilian personnel in help desk, Land Mobile Radio, Plans and Programs and Quality Assurance work centers",
            SKILLS: [
              "Leadership",
              "Management",
              "Strategic Planning",
          ...
          {
            BULLET:
              "Coordinated critical network infrastructure and airfield maintenance actions, outages, and upgrades",
            SKILLS: [
              "Leadership",
              "Management",
              "Strategic Planning",
          ...
          {
            BULLET:
              "Directed network infrastructure, VoIP, VTC, and satellite communications systems for deployed Special Operations",
            SKILLS: [
              "Leadership",
              "Management",
              "Strategic Planning",
          ...
          {
            BULLET:
              "Lead vulnerability remediation efforts; 3000 computers/printers--earned excellent on HQ Cyber Readiness inspection ",
            SKILLS: [
              "Leadership",
              "Management",
              "Strategic Planning",
          ...
          {
            BULLET:
              "Managed procurement, tracking and distribution of $25 Million in installation IT assets",
            SKILLS: [
              "Leadership",
              "Management",
              "Strategic Planning",
      ...
      },
      {
        ...
        SKILLBULLET: [
          ...
          {
            BULLET:
              "Ensured compliance with federal and Air Force mandates for software management",
            SKILLS: [
              "Leadership",
              "Management",
              "Strategic Planning",
      ...
      },
      {
        ...
        SKILLBULLET: [
          {
            BULLET:
              "Supervised maintenance actions of 42 personnel on three Avionics Test Station and " +
          ...
          {
            BULLET:
              "Developed and maintained 50 user MS Access Database - tracked production data for all maintenance actions",
            SKILLS: [
              "Management",
              "Trouble-shooting",
              "Quality Assurance",
      ...
      },
      {
        ...
        SKILLBULLET: [
          ...
          {
            BULLET:
              "Ensured compliance with safety, environmental, training, equipment account and security programs",
            SKILLS: [
              "Leadership",
              "Management",
              "Avionics",
          ...
          {
            BULLET:
              "Maintained 65 user MS Access Database - tracked production data for all maintenance actions",
            SKILLS: [
              "Management",
              "Trouble-shooting",
              "Quality Assurance",
      ...
      },
      {
        ...
        SKILLBULLET: [
          ...
          {
            BULLET:
              "Ensured assigned equipment was properly maintained, repaired and calibrated to published standards",
            SKILLS: [
              "Leadership",
              "Management",
              "Avionics",
          ...
          {
            BULLET:
              "Wrote Career Development Course Tester program in Java - helped 40+ maintainers pass qualification tests",
            SKILLS: [
              "Java",
              "Programming",
              "Object-Oriented",
      ...
      },
      {
        ...
        SKILLBULLET: [
          ...
          {
            BULLET:
              "Developed scripts for terminal emulation program to automate maintenance logging and processing procedures",
  ...
  EDUCATION: {
    ...
    ONLINE: [
      ...
      },
      {
        ...
        TOPIC:
          "HTML5, CSS3, JavaScript, Responsive Design, Website Optimization, Version Control",
      ...
      },
      {
        ...
        DATES: "Sep 2015",
        TOPIC:
          "Network defense and exploitation, security appliances and tools, national policy",
        URL: "http://www.afit.edu",
        SKILLS: [
          "Cyber Security",
          "Security+",
      ...
      },
      {
        ...
        DATES: "June 2015",
        TOPIC:
          "(40 Hours) Instructional System Design, Active Learning methods, presentation techniques",
        URL: "http://www.afit.edu",
        SKILLS: [
          "Teaching",
          "Program Management",
      ...
      },
      {
        ...
        TOPIC:
          "Security, network controls, physical controls, Cyber Security concepts, encryption, continuity planning",
      ...
      },
      {
        ...
        DATES: "Apr 2012",
        TOPIC:
          "(117 Hours) IPv4 Network training, Cisco switch & router configuration",
        URL: "#",
        SKILLS: [
          "Cyber Security",
          "Security+",
      ...
      },
      {
        ...
        DATES: "May 2009",
        TOPIC:
          "(208 Hours) Satellite Communications, Large Scale Networks, Net-Ops, Cyber Defense",
        URL: "#",
        SKILLS: [
          "Leadership",
          "Management",
      ...
      },
      {
        ...
        DATES: "Sep-Nov 2008",
        TOPIC:
          "Management, Leadership, Air and Space Military Doctrine, Critical Thinking",
        URL: "#",
        SKILLS: [
          "Leadership",
          "Management",
      ...
      },
      {
        ...
        TITLE:
          "FCC General Radiotelephone Operator's License \\w Radar Endorsement",
        DATES: "Nov 2002",
        TOPIC:
          "Electronic/RF theory, analog/digital circuitry, computing principles",
        URL: "#",
      ...
      },
      {
        ...
        DATES: "Jan-Apr 1998",
        TOPIC:
          "(504 Hours) Electronic/RF theory, analog/digital circuitry, computing principles",
        URL: "#",
  ...
  PROJECTS: {
    PROJECTS: [
      ...
      },
      {
        ...
        IMAGES: ["images/video_sample.JPG"],
        SKILLS: [
          "Software Engineering",
          "JavaScript",
          "Software Testing",
      ...
      },
      {
        ...
        EMBED:
          '<iframe src="https://mix.office.com/embed/zvbylas7wt19" frameborder="0" allowfullscreen></iframe>',
        GITURL: "https://github.com/corigami/thesis_orion_omnet",
        IMAGES: ["images/omnet.jpg"],
        SKILLS: [
          "Software Engineering",
          "Software Testing",
          "Object-Oriented",
      ...
      },
      {
        ...
        IMAGES: ["images/unityACO_sq_300.jpg", "images/unityACO_300_b.jpg"],
        SKILLS: [
          "Software Engineering",
          "JavaScript",
          "Software Testing",
      ...
      },
      {
        ...
        IMAGES: ["images/swtest_vid_player.PNG"],
        SKILLS: [
          "Software Engineering",
          "JavaScript",
          "HTML5",
      ...
      },
      {
        ...
        IMAGES: ["images/toc2_1.JPG", "images/TOC_SIMV2.PNG"],
        SKILLS: [
          "Software Engineering",
          "JavaScript",
          "HTML5",
